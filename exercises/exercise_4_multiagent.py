...
Tập trung: GDPR, CCPA, data protection, quyền của chủ thể dữ liệu, data breach, consent."""
...
def build_graph() -> StateGraph:
    ...
    graph.add_conditional_edges("check_routing", lambda x: x, ["tax_agent", "compliance_agent", "privacy_agent", "aggregate_results"])
